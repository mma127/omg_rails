...
th = Doctrine.create!(name: "tank_hunters", display_name: "Tank Hunters", const_name: "OMGUPG.PE.TANKHUNTERDOC", internal_name: "PE.DOC.tank_hunters", faction: pe)
se = Doctrine.create!(name: "scorched_earth", display_name: "Scorched Earth", const_name: "OMGUPG.PE.SCORCHEDDOC", internal_name: "PE.DOC.scorched_earth", faction: pe)
luft = Doctrine.create!(name: "luftwaffe", display_name: "Luftwaffe", const_name: "OMGUPG.PE.LUFTDOC", internal_name: "PE.DOC.luftwaffe", faction: pe)
...
rca = Doctrine.create!(name: "royal_artillery", display_name: "Canadians", const_name: "OMGUPG.CMW.ARTYDOC", internal_name: "CMW.DOC.artillery", faction: british)
