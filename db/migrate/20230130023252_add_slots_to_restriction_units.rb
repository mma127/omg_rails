class AddSlotsToRestrictionUnits < ActiveRecord::Migration[6.1]
  def change
    ...
    add_column :restriction_units, :upgrade_slots, :integer, comment: "Slots used for per model weapon upgrades"
    add_column :restriction_units, :unitwide_upgrade_slots, :integer,  comment: "Unit wide weapon replacement slot"
  end
end
