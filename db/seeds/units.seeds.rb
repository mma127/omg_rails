after :doctrines do
  ...
  SupportTeam.create!(name: "sniper_allied", const_name: "ALLY.SNIPER", display_name: "Sniper")
  SupportTeam.create!(name: "30cal_hmg", const_name: "ALLY.MG", display_name: ".30cal MG Team")
  SupportTeam.create!(name: "mortar_allied", const_name: "ALLY.MORTAR", display_name: "60mm Mortar Team")
  ...
  SupportTeam.create!(name: "officer_infantry", const_name: "ALLY.US_OFFICER", display_name: "Infantry Officer", upgrade_slots: 1)
  ...
  #################################### British ####################################
  ## Common
  Infantry.create!(name: "infantry_section", const_name: "CMW.TOMMIES", display_name: "Infantry Section", unitwide_upgrade_slots: 0, upgrade_slots: 1)
  Infantry.create!(name: "recon_section", const_name: "CMW.RECON_TOMMIES", display_name: "Recon Section", unitwide_upgrade_slots: 0, upgrade_slots: 1)
  Infantry.create!(name: "sappers", const_name: "CMW.SAPPERS", display_name: "Sappers", unitwide_upgrade_slots: 0, upgrade_slots: 1)
  Infantry.create!(name: "expert_sappers", const_name: "CMW.SAPPERS_EXPERT", display_name: "Expert Sappers", unitwide_upgrade_slots: 0, upgrade_slots: 1)

  SupportTeam.create!(name: "lt", const_name: "CMW.LT", display_name: "Lieutenant", upgrade_slots: 1)
  SupportTeam.create!(name: "captain", const_name: "CMW.CAPTAIN", display_name: "Captain", upgrade_slots: 1)
  SupportTeam.create!(name: "mortar_british", const_name: "CMW.MORTAR", display_name: "3-inch Mortar Team")
  SupportTeam.create!(name: "vickers_hmg", const_name: "CMW.TWOMAN_HMG", display_name: "Vickers HMG Team")
  SupportTeam.create!(name: "17pdr", const_name: "CMW.SEVENTEENPOUNDER", display_name: "17-pounder AT Gun")

  LightVehicle.create!(name: "universal_carrier", const_name: "CMW.UNIVERAL_CARRIER", display_name: "Universal Carrier", upgrade_slots: 1)
  LightVehicle.create!(name: "bren_carrier", const_name: "CMW.BRENGUN", display_name: "Bren Gun Carrier", upgrade_slots: 1)
  ...
  ## RCA
  Infantry.create!(name: "canadian_section", const_name: "CMW.TOMMIES_CANUK", display_name: "Canadian Infantry Section", unitwide_upgrade_slots: 0, upgrade_slots: 1)
  Infantry.create!(name: "ssf", const_name: "CMW.SSF", display_name: "Devil's Brigade", unitwide_upgrade_slots: 0, upgrade_slots: 1)
  ...
  ## Commandos
  Infantry.create!(name: "commandos", const_name: "CMW.COMMANDOS", display_name: "Commandos", unitwide_upgrade_slots: 0, upgrade_slots: 6)
  Infantry.create!(name: "piat_commandos", const_name: "CMW.PIAT_COMMANDO", display_name: "PIAT Commandos", unitwide_upgrade_slots: 0, upgrade_slots: 1)
  Infantry.create!(name: "polish_commandos", const_name: "CMW.POLES", display_name: "Polish Paratroopers", unitwide_upgrade_slots: 0, upgrade_slots: 1)
  ...
  ################################### Wehrmacht ###################################
  ## Common
  Infantry.create!(name: "volksgrenadiers", const_name: "AXIS.VOLKS", display_name: "Volksgrenadiers", unitwide_upgrade_slots: 1, upgrade_slots: 3)
  Infantry.create!(name: "grenadiers", const_name: "AXIS.GRENS", display_name: "Grenadiers", unitwide_upgrade_slots: 1, upgrade_slots: 2)
  Infantry.create!(name: "pioneers", const_name: "AXIS.PIONEER", display_name: "Pioneers", unitwide_upgrade_slots: 1, upgrade_slots: 5)
  Infantry.create!(name: "kch", const_name: "AXIS.KCH", display_name: "Knights Cross Holders", unitwide_upgrade_slots: 1, upgrade_slots: 1)

  SupportTeam.create!(name: "medic", const_name: "AXIS.MEDIC", display_name: "Combat Medic", upgrade_slots: 1)
  SupportTeam.create!(name: "mg42", const_name: "AXIS.HMG", display_name: "MG42 Team", upgrade_slots: 3)
  SupportTeam.create!(name: "mortar_axis", const_name: "AXIS.MORTAR", display_name: "81mm Mortar Team", upgrade_slots: 3)
  SupportTeam.create!(name: "pak38", const_name: "AXIS.PAK", display_name: "Pak 38")
  SupportTeam.create!(name: "sniper_axis", const_name: "AXIS.SNIPER", display_name: "Sniper")
  ...
  LightVehicle.create!(name: "puma", const_name: "AXIS.PUMA", display_name: "Puma", upgrade_slots: 2)
  ...
  ## DEFENSIVE
  Infantry.create!(name: "fortress_pioneers", const_name: "AXIS.GRENS", display_name: "Fortress Pioneers", unitwide_upgrade_slots: 1, upgrade_slots: 1)

  SupportTeam.create!(name: "officer_def", const_name: "AXIS.OFFICER", display_name: "Officer", upgrade_slots: 1)

  Emplacement.create!(name: "flak88_def", const_name: "AXIS.FLAK88", display_name: "Flak 36 88mm")

  ## BLITZ
  Infantry.create!(name: "stormtroopers", const_name: "AXIS.STORM_TROOPERS", display_name: "Stormtroopers", unitwide_upgrade_slots: 1, upgrade_slots: 2)
  Infantry.create!(name: "flammentrupp", const_name: "AXIS.FLAMETRUPP", display_name: "Flammen Trupp", upgrade_slots: 3)

  SupportTeam.create!(name: "panzer_ace", const_name: "AXIS.OFFICER_BLITZ", display_name: "Panzer Ace", upgrade_slots: 1)
  ...
  ## TERROR
  Infantry.create!(name: "sturmpioneers", const_name: "AXIS.STURMPIONEERS", display_name: "Sturmpioneers", unitwide_upgrade_slots: 1, upgrade_slots: 2)

  SupportTeam.create!(name: "saboteurs", const_name: "AXIS.SABOTEURS", display_name: "Saboteurs", upgrade_slots: 2)
  SupportTeam.create!(name: "officer_terror", const_name: "AXIS.OFFICER_TERROR", display_name: "Terror Officer", upgrade_slots: 1)
  ...
  ################################## Panzer Elite #################################
  ## Common
  Infantry.create!(name: "panzer_grenadiers", const_name: "PE.PANZER_GRENS", display_name: "Panzer Grenadiers", unitwide_upgrade_slots: 1, upgrade_slots: 1)
  Infantry.create!(name: "assault_grenadiers", const_name: "PE.ASSAULT_GRENS", display_name: "Assault Grenadier", unitwide_upgrade_slots: 1, upgrade_slots: 4)
  Infantry.create!(name: "tank_busters", const_name: "PE.TANK_BUSTERS", display_name: "Tank Busters", unitwide_upgrade_slots: 1, upgrade_slots: 4)

  LightVehicle.create!(name: "infantry_halftrack", const_name: "PE.INFANTRY_HT", display_name: "Infantry Halftrack", upgrade_slots: 1)
  ...
  ## SE
  Infantry.create!(name: "ostfront_veterans", const_name: "PE.OST_GREN", display_name: "Ostfront Veterans", unitwide_upgrade_slots: 1, upgrade_slots: 1)
  ...
  ## Luft
  Infantry.create!(name: "falls", const_name: "PE.FALLSHIRMJAGERS", display_name: "Fallshirmjäger", unitwide_upgrade_slots: 1, upgrade_slots: 1)
  Infantry.create!(name: "gebirgs", const_name: "PE.FSJ_SCOUT", display_name: "Gebirgsjäger", unitwide_upgrade_slots: 1, upgrade_slots: 1)
  Infantry.create!(name: "luft_infantry", const_name: "PE.LUFTWAFFE", display_name: "Luftwaffe Infantry", unitwide_upgrade_slots: 1, upgrade_slots: 1)
  Infantry.create!(name: "crete_vets", const_name: "PE.FSJ_AT", display_name: "Crete Veterans", unitwide_upgrade_slots: 1, upgrade_slots: 1)
