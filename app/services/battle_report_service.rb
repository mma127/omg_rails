class BattleReportService < ApplicationService
  ...
  def self.enqueue_report(battle_id, is_final, reporting_player_name, time_elapsed, race_winner, map_name,
    ...
    info_logger("Enqueuing BattleReportJob for battle #{battle_id} with params:")
    info_logger("is_final #{is_final}, reporting player #{reporting_player_name}, time_elapsed #{time_elapsed}, winner #{race_winner}")
    info_logger("dead_squads #{dead_squads}, surviving_squads #{surviving_squads}")
