...
import axis_panzerschreck from '../../../assets/images/doctrines/wehrmacht/upgrades/panzerschreck.png'
...
import wp from '../../../assets/images/doctrines/americans/upgrades/t17_wp.png'
import at_rifles from '../../../assets/images/doctrines/british/upgrades/boys_at.png'

import mines from '../../../assets/images/doctrines/common/upgrades/mines.png'

export const ADVANCED_REPAIR = 'advanced_repair'
export const ANTI_BUILDING_GRENADE = 'anti_building_grenade'
...
export const P4_IST_WP = 'p4_ist_wp'
...
export const upgradeImageMapping = {
  ...
  [ANTI_BUILDING_GRENADE]: flame_grenade,
  [APCR_AT_HT]: apcr,
  [APCR_HETZER]: apcr,
  [APCR_MARDER]: apcr,
  [APCR_PANTHER]: apcr,
  ...
  [FLAME_HOTCHKISS_STUKA]: hotchkiss_stuka,
